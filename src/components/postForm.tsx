...
function Form () {
    return (
        <form className="flex border-b px-4 py-2">
            ...
            <button className="mr-8 h-10 w-10 absolute right-0 top-1/2 transform -translate-y-1/2 border-l border-b border-orange-500 self-end  rounded-full bg-slate-50 text-slate-950 text-xl">🡹</button>
